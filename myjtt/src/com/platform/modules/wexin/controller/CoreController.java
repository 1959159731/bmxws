package com.platform.modules.wexin.controller;
...
import com.platform.common.utils.wexin.SignUtil;
import com.platform.common.utils.wexin.WeixinConstans;
import com.platform.common.utils.wexin.WeixinUtil;

/**
 * 微信主响应类
 * 
 * @author liuxiaolei 下午1:57:39 v1.0
 */

@Controller
@RequestMapping(value = "${frontPath}/coreweixin")
public class CoreController {
	...
	public void getService(HttpServletRequest request, HttpServletResponse response,
		...
		if (SignUtil.checkSignature(WeixinConstans.WEIXIN_ACCOUNT_TOKEN, signature, timestamp, nonce)) {
			try {
