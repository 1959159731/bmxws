 ...
 * @version 2017-12-04
 */
public class SafeSpecEqui extends DataEntity<SafeSpecEqui> {
	...
	private String inspectionCertnum;					// 检验合格证书编号
	...
	@Length(min=1, max=64, message="检验合格证书编号长度必须介于 1 和 64 之间")
	@ExcelField(title="合格证书编号", align=2, sort=110)
	public String getInspectionCertnum() {
		return inspectionCertnum;
	}

	public void setInspectionCertnum(String inspectionCertnum) {
		this.inspectionCertnum = inspectionCertnum;
	}
