 ...
 * @version 2017-11-26
 */
public class SafeSpecOperPerson extends DataEntity<SafeSpecOperPerson> {
	...
	private Date certificateValid;				// 有效期
	private String certificatePath;				// 证书存储地址
	...
	public SafeSpecOperPerson() {
		super();
	}

	public SafeSpecOperPerson(String id){
		super(id);
	}
	...
	@ExcelField(title="作业工点或位置", align=2, sort=90)
