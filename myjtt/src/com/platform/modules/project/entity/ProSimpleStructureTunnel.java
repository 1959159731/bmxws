 ...
 * @version 2017-12-08
 */
public class ProSimpleStructureTunnel extends DataEntity<ProSimpleStructureTunnel> {
	...
	public ProSimpleStructureTunnel() {
		super();
	}

	public ProSimpleStructureTunnel(String id){
		super(id);
	}
