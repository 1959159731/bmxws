...
//	}
	...
	/**
	 * 给模板里面添加检测点、合格点、合格率数据
	 * @param data
	 * @return
	 */
	public ImportExcel setData(Map<String, ArrayList> data){
		ArrayList<Integer> checkPointList = data.get("checkPoint"); 	// 检测点
		ArrayList<Integer> passedPointList =  data.get("passedPoint"); 	// 合格点
		ArrayList<String> passedRateList = data.get("passedRate");		// 合格率
		for (int i = 2; i < 117; i++) {
			Row row = this.sheet.getRow(i);
			Cell cell4 = row.getCell(3);
			cell4.setCellValue(checkPointList.get(i-2));
			Cell cell5 = row.getCell(4);
			cell5.setCellValue(passedPointList.get(i-2));
			Cell cell6 = row.getCell(5);
			cell6.setCellValue(passedRateList.get(i-2));
		}
		return this;
	}
