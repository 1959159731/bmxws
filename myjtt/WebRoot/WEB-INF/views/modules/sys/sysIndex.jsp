...
<html>
<head>
	<title>${fns:getConfig('systemName')}</title>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"><span id="productName">${fns:getConfig('systemName')}</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; ${fns:getConfig('copyrightYear')} ${fns:getConfig('systemName')} - Powered By <a href="${fns:getConfig('productWeb')}" target="_blank">${fns:getConfig('productName')}</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
		var leftWidth = 188; // 左侧窗口大小
