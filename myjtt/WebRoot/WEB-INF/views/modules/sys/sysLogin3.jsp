...
<html>
<head>
	<title>${fns:getConfig('systemName')} 登录</title>
...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
		...
		<input class="btn btn-large btn-primary login" type="submit" value="登 录"/>&nbsp;&nbsp;
	</form>
	<div class="footer">
		Copyright &copy; ${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('systemName')}</a> - Powered By <a href="${fns:getConfig('productWeb')}" target="_blank">${fns:getConfig('productName')}</a> ${fns:getConfig('version')} 
	</div>
