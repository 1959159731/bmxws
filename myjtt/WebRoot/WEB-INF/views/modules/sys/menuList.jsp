		...
		<table id="treeTable" class="table table-striped table-bordered table-condensed hide">
			<thead>
				<tr>
					...
					<th>可见</th>
					<th>权限标识</th>
					<shiro:hasPermission name="sys:menu:edit"><th style="text-align: center">操作</th></shiro:hasPermission>
				</tr>
			</thead>
			<tbody><c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					...
					<shiro:hasPermission name="sys:menu:edit"><td style="text-align: center">
						<a href="${ctx}/sys/menu/form?id=${menu.id}" title="编辑"><i class="icon-edit"></i></a>&nbsp;&nbsp;
						<a href="${ctx}/sys/menu/delete?id=${menu.id}" onclick="return confirmx('要删除该菜单及所有子菜单项吗？', this.href)" title="删除"><i class="icon-remove"></i></a>&nbsp;&nbsp;
						<a href="${ctx}/sys/menu/form?parent.id=${menu.id}" title="添加下级菜单"><i class="icon-plus"></i></a>
