...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/quality/qualityConsTestroomRemark/">施工单位试验室备案信息列表</a></li>
		<li class="active"><a href="${ctx}/quality/qualityConsTestroomRemark/form?id=${qualityConsTestroomRemark.id}">施工单位试验室备案信息<shiro:hasPermission name="quality:qualityConsTestroomRemark:edit">${not empty qualityConsTestroomRemark.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="quality:qualityConsTestroomRemark:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="qualityConsTestroomRemark" action="${ctx}/quality/qualityConsTestroomRemark/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
10、隧道：断面轮廓、锚杆拉拔。
	...................."
		...
		<div class="form-actions">
			<shiro:hasPermission name="quality:qualityConsTestroomRemark:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
