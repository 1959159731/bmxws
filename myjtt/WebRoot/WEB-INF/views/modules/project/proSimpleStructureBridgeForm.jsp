...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/project/proSimpleStructureBridge/">主要结构物桥梁列表</a></li>
		<li class="active"><a href="${ctx}/project/proSimpleStructureBridge/form?id=${proSimpleStructureBridge.id}">主要结构物桥梁<shiro:hasPermission name="project:proSimpleStructureBridge:edit">${not empty proSimpleStructureBridge.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="project:proSimpleStructureBridge:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="proSimpleStructureBridge" action="${ctx}/project/proSimpleStructureBridge/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="project:proSimpleStructureBridge:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
